    ...
    <div className="space-y-6">
      ...
      <details className="bg-white rounded-xl border border-gray-200 p-5 group">
        ...
        <div className="mt-3 space-y-3 text-sm text-gray-600">
          <div>
            <p className="font-medium text-gray-800 mb-1">1. 여러 곳에서 한 번에 찾아요</p>
            <p>정부에 등록된 사업자 정보, 네이버(검색·지도·쇼핑), 구글을 <b>동시에 뒤져서</b> 원하시는 업체를 모읍니다. 한 군데만 보는 게 아니라 여러 곳을 겹쳐 보기 때문에 더 많이 찾습니다.</p>
          </div>
          <div>
            <p className="font-medium text-gray-800 mb-1">2. 같은 가게는 하나로 합쳐요</p>
            <p>여러 곳에서 같은 가게가 나오면 하나로 묶습니다. 이때 <b>한 곳엔 전화번호만, 다른 곳엔 이메일만</b> 있으면 둘을 합쳐서 <b>더 완전한 정보</b>로 만들어 드립니다.</p>
          </div>
          <div>
            <p className="font-medium text-gray-800 mb-1">3. 이런 건 못 가져와요 (미리 알려드려요)</p>
            <p>개인 <b>휴대폰 번호</b>는 법으로 보호돼서 못 가져옵니다. 그리고 그 가게가 <b>어디에도 공개하지 않은 연락처</b>는 세상에 없는 정보라 어떤 방법으로도 찾을 수 없습니다. 이런 곳은 전화나 인스타 DM으로 접근하시는 걸 추천합니다.</p>
          </div>
        </div>
      </details>
