...
⚠️ 상태(2026-08-29): localdata.go.kr는 2026-04-16 '폐쇄'됐다(점검이 아니라
   완전 종료 — data.go.kr로 통합). 이 파일의 구주소는 영구히 죽었다.
   대체: data.go.kr의 통합 API '행정안전부_식품_일반음식점 조회서비스'(15154916),
   '휴게음식점'(15154921) 등으로 재작성해야 하며, 그때까지 파이프라인에서 제외됨.
"""
import logging
import os
